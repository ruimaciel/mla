...
BOOST_AUTO_TEST_CASE_TEMPLATE( blas_level1_test_dot_one_dense, VectorType, vector_type_list )
{
	using namespace mla;
...
BOOST_AUTO_TEST_CASE_TEMPLATE( blas_level1_test_dot_one_sparse, VectorType, vector_type_list )
{
	using namespace mla;
